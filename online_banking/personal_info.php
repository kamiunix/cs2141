...
<div id="main">
    ...
    <?php
        // Get customer information
            ...
            echo '<h2>&emsp;Address:&emsp;'.$row['address'].'</h2><br>';
            echo '<h2>&emsp;City:&emsp;'.$row['city'].'</h2><br>';
            echo '<h2>&emsp;Postal Code:&emsp;'.$row['postal_code'].'</h2><br>';
            echo '<h2>&emsp;Date of Birth:&emsp;'.$row['dob'].'</h2><br>';
            echo '<h2>&emsp;Banker:&ensp; '.$row['banker_fname'].' '.$row['banker_lname'].'</h2><br>';
            echo '</div>';
    ?>
